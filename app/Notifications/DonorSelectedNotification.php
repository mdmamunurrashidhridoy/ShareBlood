...
class DonorSelectedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            'type' => 'donor_selected',
            'title' => 'You were selected as a donor',
            'message' => "You were selected for the blood request for {$this->bloodRequest->patient_name}. Please contact the requester.",
