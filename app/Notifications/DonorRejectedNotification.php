...
class DonorRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            'type' => 'donor_rejected',
            'title' => 'Your donor response was not selected',
            'message' => "Your donor response for {$this->bloodRequest->patient_name} was not selected.",
